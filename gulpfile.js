...
var webpackStatusConfig = require('./common/status/webpack.config')
var gettext = require('gulp-angular-gettext')
var pug = require('gulp-pug')
var del = require('del')
// var protractor = require('gulp-protractor')
var protractor = require('./test/e2e/helpers/gulp-protractor-adv')
var protractorConfig = './test/protractor.conf'
...
if (gutil.env.multi) {
  protractorConfig = './test/protractor-multi.conf'
}
else if (gutil.env.appium) {
  protractorConfig = './test/protractor-appium.conf'
}
...
gulp.task('translate:extract', ['pug'], function() {
  return gulp.src([
    ...
    .pipe(gulp.dest('./common/lang/po/'))
})

gulp.task('translate:compile', function() {
  return gulp.src('./common/lang/po/**/*.po')
    .pipe(gettext.compile({
      format: 'json'
    }))
    .pipe(gulp.dest('./common/lang/translations/'))
})
